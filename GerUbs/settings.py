"""
Django settings for GerUbs project.
...
SECRET_KEY = 'django-insecure-0^@&ex4_aj%7496whd!uvam^r_&2@ymq_8+^vuplz%ea7t++ml'
...
WSGI_APPLICATION = 'GerUbs.wsgi.application'
